...
const ContainerLoad = () => {
  <div className="min-w-[270px] md:min-w-[40vw] h-[150px] md:h-[40vh] bg-grey rounded-lg mx-3">
    <div className="animate-pulse h-full flex flex-row">
      ...
      <div className="flex flex-col m-2 flex-1 md:pt-1">
        ...
        <div className="w-[55px] md:w-[86px] h-[15px] md:h-[29px] bg-dummy rounded-sm self-end mt-4"></div>
      </div>
    </div>
  </div>;
};
      ...
      {data?.map((anime) => {
        return (
          <div
            ...
            style={{
              transform: `translateX(${-(width + 24) * (currentSlide - 1)}px)`,
            }}
          >
            <img
            ...
            <div className="flex flex-col m-2 md:m-4 flex-1">
              <h2 className="text-[10px] md:text-lg 2xl:text-2xl text-center font-bold notranslate">
                {anime.title}
              </h2>
              <p className="text-[8px] md:text-[13px] 2xl:text-lg text-justify w-full mt-2 tracking-tighter cut-text">
                {anime.synopsis}
              </p>
              <Link
      ...
      <div className="flex flex-row justify-center items-center">
        ...
        <div className="flex flex-row overflow-hidden w-[294px] md:w-[43%]">
          {isFetching ? (
            ...
            <Container data={topAnime} currentSlide={currentSlide} />
          )}
        </div>
        <button>
          <RiArrowRightSLine
      ...
      <div className="flex mx-auto my-2 justify-center">
        {topAnime?.map((d, index) => (
          <div
            ...
            className={`${
              currentSlide === index + 1 ? "bg-white" : "bg-[#898282]"
