...
const TopAnime = () => {
  ...
  const { data, isFetching, error } = useGetTopAnimePageQuery({
    type,
    page,
  });
  ...
  return (
    <>
      <h2 className="text-white text-center text-sm md:text-xl font-bold notranslate">
        Top Anime {type.charAt(0).toUpperCase() + type.slice(1)}
      </h2>
      <select
